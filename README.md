...
The datasets are designed for group hands-on exercises demonstrating resequencing and RNA sequencing (RNA-seq) workflows using Google Cloud Console and Nextflow pipelines.
